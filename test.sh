...
# always emit the per-sample visual analysis bundle.
...
echo "- Visual report: ./analysis (generated by default via --visual_report)"
echo "  (metrics & tables: visual_report.txt/json, fpr_values.csv, image_scores.csv)"
